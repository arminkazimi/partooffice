...
def toggle_page(request):
    ...
    if current == 'office':
        ...
        return render(request, 'pages/partials/parto/index.html', context=context)
    elif current == 'parto':
        ...
        return render(request, 'pages/partials/office/index.html', context=context)
...
def description(request):
    ...
    about = AboutMe.objects.first()
    context = {'active_section': 'description', 'object': about, }
    return render(request, 'pages/partials/parto/description.html', context)
...
def event_detail_view(request, pk):
    ...
    return render(request, 'pages/partials/parto/event-detail.html', context)


def contact(request):
    contact_me = ContactMe.objects.first()
    context = {'active_section': 'contacts', 'object':contact_me}
    return render(request, 'pages/partials/parto/contacts.html', context)


def job(request):
    context = {'active_section': 'jobs', }
    return render(request, 'pages/partials/parto/jobs.html', context)


def project_list_view(request):
    projects = Project.objects.all().order_by('-created_at')
    context = {'active_section': 'projects', 'projects': projects}
    return render(request, 'pages/partials/office/projects.html', context)


def project_detail_view(request, pk):
    project = get_object_or_404(Project, pk=pk)
    context = {'project': project, 'images': project.images.all()}
    return render(request, 'pages/partials/office/project.html', context)
...
def get_product_view(request):
    ...
    return render(request, 'pages/partials/office/production.html', context)


def create_design_view(request):
    context = {'active_section': 'design_form', }
    return render(request, 'pages/partials/office/design-form.html', context)


def education_view(request):
    context = {'active_section': 'education', }
    return render(request, 'pages/partials/office/education.html', context)
